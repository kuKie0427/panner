...
class DuckDuckGoSearchTool(Tool):
    ...
    Examples:
        ```python
        >>> from panner import DuckDuckGoSearchTool
...
class ApiWebSearchTool(Tool):
    ...
    Examples:
        ```python
        >>> from panner import ApiWebSearchTool
...
class WikipediaSearchTool(Tool):
    ...
    Example:
        ```python
        >>> from panner import CodeAgent, InferenceClientModel, WikipediaSearchTool
        >>> agent = CodeAgent(
        >>>     tools=[
        >>>            WikipediaSearchTool(
    ...
    def __init__(
        self,
        user_agent: str = "Panner (myemail@example.com)",
        language: str = "en",
