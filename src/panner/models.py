    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not _is_package_available("vllm"):
            raise ModuleNotFoundError("Please install 'vllm' extra to use VLLMModel: `pip install 'panner[vllm]'`")
...
class MLXModel(Model):
    ...
    > [!TIP]
    > You must have `mlx-lm` installed on your machine. Please run `pip install 'panner[mlx-lm]'` if it's not the case.
        ...
        **kwargs,
        ...
        if not _is_package_available("mlx_lm"):
            raise ModuleNotFoundError(
                "Please install 'mlx-lm' extra to use 'MLXModel': `pip install 'panner[mlx-lm]'`"
            )
        import mlx_lm
...
class TransformersModel(Model):
    ...
    > [!TIP]
    > You must have `transformers` and `torch` installed on your machine. Please run `pip install 'panner[transformers]'` if it's not the case.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'transformers' extra to use 'TransformersModel': `pip install 'panner[transformers]'`"
            )
...
class LiteLLMModel(ApiModel):
    ...
    def create_client(self):
        ...
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'litellm' extra to use LiteLLMModel: `pip install 'panner[litellm]'`"
            ) from e
...
class LiteLLMRouterModel(LiteLLMModel):
    ...
    ```python
    >>> import os
    >>> from panner import CodeAgent, WebSearchTool, LiteLLMRouterModel
    ...
    def create_client(self):
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'litellm' extra to use LiteLLMRouterModel: `pip install 'panner[litellm]'`"
            ) from e
...
class OpenAIModel(ApiModel):
    ...
    def create_client(self):
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'openai' extra to use OpenAIModel: `pip install 'panner[openai]'`"
            ) from e
...
class AzureOpenAIModel(OpenAIModel):
    ...
    def create_client(self):
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'openai' extra to use AzureOpenAIModel: `pip install 'panner[openai]'`"
            ) from e
...
class AmazonBedrockModel(ApiModel):
    ...
    def _prepare_completion_kwargs(
        ...
        **kwargs,
        ...
        # Not all models in Bedrock support `toolConfig`. Also, panner already include the tool call in the prompt,
    ...
    def create_client(self):
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'bedrock' extra to use AmazonBedrockServerModel: `pip install 'panner[bedrock]'`"
            ) from e
