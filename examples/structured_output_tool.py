...
#
# Modify the panner dependency to point to the local panner repo or
# remove `@ file:///<path-to-panner>`
#
# /// script
# requires-python = ">=3.10"
# dependencies = [
#   "panner[mcp,litellm] @ file:///<path-to-panner>",
#   "pydantic",
# ]
# ///
...
from panner import CodeAgent, InferenceClientModel, LiteLLMModel, MCPClient  # noqa: F401
