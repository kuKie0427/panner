# Panner Chat Server Demo

This is a simple web server that provides a chat interface for interacting with an AI code agent powered by `panner` and the Qwen3-Next-80B-A3B-Thinking model, enhanced with MCP (Model Control Protocol) tools.
...
```bash
pip install starlette anyio 'panner[mcp]' uvicorn
```
