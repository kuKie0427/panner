...
from panner.default_tools import (
...
from panner.local_python_executor import ExecutionTimeoutError
...
class TestWebSearchToolExa:
    ...
    def test_exa_search_results(self):
        ...
        assert call_kwargs.kwargs["headers"]["x-exa-integration"] == "panner"
