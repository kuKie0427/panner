...
from panner.default_tools import FinalAnswerTool
...
class TestModel:
    def test_prepare_completion_kwargs_parameter_precedence(self):
        ...
        from panner.models import REMOVE_PARAMETER
    ...
    def test_agglomerate_stream_deltas(self):
        ...
        from panner.monitoring import TokenUsage
...
class TestLiteLLMModel:
    ...
    def test_retry_on_rate_limit_error(self):
        ...
        with (
            patch("panner.models.RETRY_WAIT", 0.1),
            patch("panner.utils.random.random", side_effect=[0.1, 0.1]),
            patch("panner.models.LiteLLMModel.create_client", return_value=mock_litellm),
        ):
...
def test_get_clean_message_list_image_encoding(convert_images_to_image_urls, expected_clean_message):
    ...
    with patch("panner.models.encode_image_base64") as mock_encode:
...
def test_tool_calls_json_serialization(model_class, model_id):
    ...
    if model_class == OpenAIModel:
        ...
        patch_target = "panner.models.OpenAIModel.create_client"
        ...
        patch_target = "panner.models.LiteLLMModel.create_client"
    else:
