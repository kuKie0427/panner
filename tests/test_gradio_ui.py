...
from panner.gradio_ui import GradioUI, pull_messages_from_step, stream_to_gradio
from panner.memory import ActionStep, FinalAnswerStep, PlanningStep, ToolCall
from panner.models import ChatMessageStreamDelta
from panner.monitoring import Timing, TokenUsage
...
class TestStreamToGradio:
    ...
    @patch("panner.gradio_ui.pull_messages_from_step")
...
class TestPullMessagesFromStep:
    ...
    def test_action_step_with_images(self):
        ...
        with patch("panner.gradio_ui.AgentImage") as mock_agent_image:
