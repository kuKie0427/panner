...
from panner.agent_types import _AGENT_TYPE_MAPPING
from panner.tools import AUTHORIZED_TYPES, Tool, ToolCollection, launch_gradio_demo, tool, validate_tool_arguments
...
@pytest.fixture
def mock_panner_adapter():
    with patch("mcpadapt.panner_adapter.SmolAgentsAdapter") as mock:
        yield mock
...
class TestToolCollection:
    def test_from_mcp(self, mock_server_parameters, mock_mcp_adapt, mock_panner_adapter):
